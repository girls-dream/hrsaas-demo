  ...
  <div class="dashboard-container">
    <div class="app-container">
      <pageTools :isShowLeft="false">
        <template slot="right">
          <el-button @click="showAddDialog(formData.pid, 1)"
            >添加权限</el-button
          >
        </template>
      </pageTools>
      ...
      <!-- 放置一个弹层 用来编辑新增节点 -->
      <el-dialog @close="onClose" title="添加权限" :visible="showDialog">
        <!-- 表单 -->
        <el-form
          ref="form"
          :model="formData"
        ...
        <el-row slot="footer" type="flex" justify="center">
          <el-col :span="6">
            <el-button size="small" type="primary" @click="onSave"
              >确定</el-button
            >
            <el-button size="small" @close="onClose">取消</el-button>
          </el-col>
        </el-row>
      </el-dialog>
    </div>
